...
const Footer = () => {
    return (
       <div className=' bg-sky-50 mt-28'>
                <div className='mx-16 mt-14 flex justify-around px-2 pt-10 pb-5 leading-relaxed'>
                <div className='w-2/6 p-3'>
                    <div className='flex'>
                        <img className='w-1/5 ' src="Images/logo.png" alt="" />
                        <p className='ps-4'>Linda - Improve Your Online Learning Experience Better Instantly. We have 50k+ Online courses & 600K+ Online registered student.Find your desired Courses from them.</p>
                    </div>
